...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-two-sidebar">
		...
		<div id="content" class="content">
			...
			<h1 class="page-header">Khairat Payment <small> Precious Lives awaiting your Khairat </small></h1>
			    ...
			    <div class="col-lg-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Khairat</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
							...
							<div class="form-group row m-b-15">
								...
								<div class="col-md-8">
									<label class="col-form-label">Khairat</label>
