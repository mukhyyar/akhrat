...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-two-sidebar">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Hadith <small>  </small></h1>
			    ...
			    <div class="col-lg-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Hadith / Sunnat</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
								...
								<div class="form-group row m-b-15">
									<label class="col-form-label col-md-3">Hadith</label>
									<div class="col-md-9">
								...
								<div class="form-group row m-b-15">
									<label class="col-form-label col-md-3">Sunnat</label>
									<div class="col-md-9">
										<select class="form-control">
											<option>Select</option>
											<option>Yes</option>
